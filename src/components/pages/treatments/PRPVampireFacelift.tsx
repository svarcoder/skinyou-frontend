...
const PRPVampireFacelift: React.FC = () => {
  useLayoutEffect(() => {
    window.scrollTo(0, 0);
  });
  return (
          ...
          <div className="row g-5">
            <div className="col-lg-9">
              <div className="mb-5">
                ...
                <p>
                  The Vampire Facelift is a procedure for healthy, youthful, and
                ...
                <p>
                  ...
                  ways. Increases the blood flow to the skin, resulting in
                  healthier and flawless skin. Increases new cell formation for
                  skin renewal.
                </p>
                <p>
                  Causes production of new collagen, the major component of
                  facial skin that decreases in facial aging.
                </p>
                <p></p>Activates the stem cells in the skin, resulting in the
                generation of new, younger-skin. A quick procedure that keeps
                ...
                <p>
                  ...
                  advanced signs of aging may benefit more by adding solution.
                </p>
                <p>
                ...
                <h5>WHY SKIN & YOU CLINICFOR VAMPIRE FACE LIFT?</h5>
                <p>
...
export default PRPVampireFacelift;
